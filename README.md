...
Looks for changes in TypeScript files and updates JavaScript files for development.

```sh
npm run watch
```

Builds JavaScript from the TypeScript files for the productive environment.
