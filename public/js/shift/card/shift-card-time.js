...
export default class ShiftCardTime extends HTMLElement {
    constructor() {
        super();
    ...
    attributeChangedCallback(name, oldVal, newVal) {
        if (name === "date-from") {
            ...
            this._shadowRoot.querySelector("#date-from").innerText = `${hours}:${minutes}`
            return
        }
        ...
        if (name === "date-to") {
            ...
            this._shadowRoot.querySelector("#date-to").innerText = `${hours}:${minutes}`
        }
    }
}