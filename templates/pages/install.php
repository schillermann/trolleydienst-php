    ...
    <form method="post">
        ...
        <fieldset>
            ...
            <div>
                ...
                <input id="application_name" name="application_name" required value="<?= (isset($_POST['application_name']))? $_POST['application_name'] : 'Öffentliches Zeugnisgeben' ?>">
            </div>
            <div>
                <label for="team_name">Team Name <small>(Pflichtfeld)</small></label>
                <input id="team_name" name="team_name" required value="<?= (isset($_POST['team_name']))? $_POST['team_name'] : 'Trolley Team' ?>">
            </div>
            <div>
