<?php if (isset($placeholder['message'])) : ?>
    <div id="note-box" class="fade-in">
		<?php if (isset($placeholder['message']['success'])) : ?>
            <p class="success">
                <?php echo __("Folgende Schichten wurden angelegt:"); ?>
            <ul>
		...
		<?php elseif(isset($placeholder['message']['error'])): ?>
            <p class="error">
            <?php echo __("Folgende Schichten konnten nicht angelegt werden:"); ?>
            <ul>
...
<?php endif; ?>
<header>
    <h2><?php echo __("Neue Schichten"); ?></h2>
</header>
<nav id="nav-sub">
    ...
    <form method="post">
        <fieldset>
            ...
            <div>
                ...
                <input id="route" name="route" required placeholder="<?php echo __("Wie heißt die Route?"); ?>" value="<?php echo (isset($_POST['route']))? $_POST['route'] : '';?>">
            </div>
            <div>
            ...
            <div>
                <label for="shiftday_series_until"><?php echo __("Terminserie bis zum"); ?></label>
