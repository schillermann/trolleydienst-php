...
class AdjustShiftTypePage implements PageInterface
{
    public function viaOutput(OutputInterface $output): OutputInterface
    {
        ...
        if (isset($_POST['save'])) {
            ...
            if (Shift\ShiftTypeTable::update($database_pdo, $id_shift_type, $name, $shift_type_info, $user_per_shift_max))
            ...
            if (Shift\ShiftTypeTable::delete($database_pdo, $id_shift_type)) {
                header('location: /shift-type');
                exit;
            }
        }

        $placeholder['shift_type'] = Shift\ShiftTypeTable::select($database_pdo, $id_shift_type);
